...
#define STRING_CONFIG_H_AUTHOR "(Gabriele Bosco)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Predator 2.0.4"
...
#define DELTA
  ...
  #define DELTA_TOWER_ANGLE_TRIM { 0.07, -0.08, 0.01 } // Get these values from G33 auto calibrate
...
#define CLASSIC_JERK
  ...
  #define DEFAULT_YJERK 6 // DEFAULT_XJERK
  #define DEFAULT_ZJERK 6 // DEFAULT_XJERK  Must be same as XY for delta
 ...
 *
 */
#define Z_MIN_PROBE_PIN P0_10 // Pin assegnato al PROBE per la SRK 1.4/turbo
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -16.39 }
